...
| Image Data Resource (IDR) | [IDR WebPage](https://idr.openmicroscopy.org/) and [Paper Williams et al., 2017](https://www.nature.com/articles/nmeth.4326) | IDR is is a public repository of image datasets from published articles, mainly focus on cell and tissue acquisition from electron microscopy to super-resolution staining, that is constantly updated. |
